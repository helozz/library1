...
#define GAME_H
#include <json/json.h>
#include "/home/helga/Рабочий стол/projects/_Mapper/json/json.h"
#include <stdio.h>
#include <iostream>
#include <time.h>
#include <sys/time.h>
...
{
    public:
        game(int,string,string,string,string,string,string,string,string,string,string,string,string,string,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,string);
        virtual ~game();
...
void doMapSeek(int,int,int=1);
void doVisitUser(int,int);
